...
1. Check SCSS modules — typo? wrong selector? missing import?
...
5. If dark mode issue: check dark mode variables applied
...
1. Retry once
2. If 2 consecutive failures: print output directly to logs
